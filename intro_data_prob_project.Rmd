...
The relevant variables here are chcscncr (Ever told you had skin cancer), chcocncr (Ever told you had any other type of cancer), and income2 (income level).  First, for our purposes
```{r}
